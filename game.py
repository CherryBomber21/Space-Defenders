...
def update_inos(screen, gun, inos, bullets):
    # обновление положения пришельцев
    inos.update()
...
def inos_check(screen, gun, inos, bullets):
    # обработка окончания игры(добрались ли пришельцы до окнца экрана)
...
if __name__ == '__main__':
    ...
    while True:
        if start_window:
            ...
            screen.blit(pygame.image.load('images/заставка.jpeg'), (0, 0))
